...
var searchHistory = [];
var searchedCityBtns = document.querySelector
...
function getLocalStorage() {
  var storageData = localStorage.getItem('search')

  if (storageData) {
    searchHistory = JSON.parse(storageData)
  }
  renderSearchBtn()
}
...
function renderSearchBtn() {
  ...
  for (var i = 0; i < searchHistory.length; i++) {
    ...
    btn.setAttribute('data-language', searchHistory[i])
